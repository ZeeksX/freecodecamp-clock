    ...
    <div class="length-controls">
      <div class="break">
        ...
        <div class="break-controls">
          <div>
            <h3 id="break-decrement"><i class="fa-solid fa-arrow-down fa-2x"
                @click="counterStore.decreaseBreakTime"></i></h3>
          </div>
          <div>
            <h3 id="break-length">{{ counterStore.break }}</h3>
          </div>
          <div>
            <h3 id="break-increment" @click="counterStore.increaseBreakTime"><i class="fa-solid fa-arrow-up fa-2x"></i>
            </h3>
          </div>
        </div>
      </div>
      <div class="session">
        ...
        <div class="session-controls">
          <div>
            <h3 id="session-decrement"><i class="fa-solid fa-arrow-down fa-2x"
                @click="counterStore.decreaseSessionTime"></i></h3>
          </div>
          <div>
            <h3 id="session-length">{{ counterStore.session }}</h3>
          </div>
          <div>
            <h3 id="session-increment"><i class="fa-solid fa-arrow-up fa-2x"
                @click="counterStore.increaseSessionTime"></i></h3>
          </div>
        </div>
      </div>
    </div>
